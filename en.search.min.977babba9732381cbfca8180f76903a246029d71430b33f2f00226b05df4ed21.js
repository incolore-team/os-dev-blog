...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.81f9afa7bd4478d82758584131525beacc228d4f7d4b9a7e3d8a843fc7b013ad.js',function(){input.required=false;search();});}
